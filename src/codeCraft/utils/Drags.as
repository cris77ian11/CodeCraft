package codeCraft.utils {
	...
	public class Drags extends MovieClip {
		...
		public static function load(object:*, positionOrigin:Boolean = true, center:Boolean = false):void {
			try {
				...
				arrayTemp = new Array(object, positionOrigin, center);
				...
				Validation.error('Un parametro no esta permitido en la funcion load de la clase Drags');
			}
		}
